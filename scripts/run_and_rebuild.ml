...
let run_project () =
  let cmd = ["opam"; "exec"; "--";  "dune"; "exec"; "./server/main.exe"; "--"] @ args in
  let proc =
...
let bin_watch = Inotify.add_watch inotify "./server" [Inotify.S_Modify; Inotify.S_Create]

let js_watch = Inotify.add_watch inotify "./web" [Inotify.S_Modify; Inotify.S_Create]

let data_watch = Inotify.add_watch inotify "./static" [Inotify.S_Modify; Inotify.S_Create]
let data_watch = Inotify.add_watch inotify "./static/css" [Inotify.S_Modify; Inotify.S_Create]
let data_watch = Inotify.add_watch inotify "./static/js" [Inotify.S_Modify; Inotify.S_Create]
